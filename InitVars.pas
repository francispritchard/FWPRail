...
VAR
  ...
  MainWindowCanvasPenWidth : Integer;
  MainWindowInitialised : Boolean = False;
  MainWindowPartInitialised : Boolean = False;
  ...
  ReinitialiseMainWindowVariables : Boolean = False;
...
BEGIN
  ...
  DefaultMainWindowTop := 0;
  DefaultMainWindowLeft := 0;
  DefaultMainWindowHeight := MulDiv(Screen.WorkAreaHeight, DefaultMainWindowHeight, 100);
  DefaultMainWindowWidth := Screen.DeskTopWidth;
