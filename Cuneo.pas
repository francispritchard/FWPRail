...
USES RailDraw, Locks, Startup, Route, GetTime, Diagrams, MiscUtils, Movement, Lenz, Input, LocoUtils, Types, CreateRoute, LocoDialogue, LocationsUnit, Help, StrUtils,
     Options, Main, DateUtils, PointsUnit, TrackCircuitsUnit, LinesUnit, Train, Logging;
...
BEGIN
  TRY
    ...
    IF InLockDebuggingMode THEN BEGIN
...
//                      TheatreSignalSetting := False;
  ...
  BEGIN
    ...
    END ELSE BEGIN
      IF NOT InStationStartMode THEN
      ...
      END ELSE BEGIN
        ...
        THEN BEGIN
          ...
          ELSE BEGIN
            ...
            ELSE BEGIN
              IF InStationStartMode AND (S > 0) AND (S <> UnknownSignal) AND Signals[S].Signal_TRSHeld THEN BEGIN
