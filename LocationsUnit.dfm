object LocationsUnitWindow: TLocationsUnitWindow
  Left = 0
  Top = 0
  Align = alClient
  Caption = 'LocationsUnitWindow'
  ClientHeight = 237
  ClientWidth = 619
  Color = clBtnFace
  ...
  object LocationsUnitWindowGrid: TStringGrid
    ...
    FixedRows = 0
    TabOrder = 0
    OnDrawCell = LocationsUnitWindowGridDrawCell
    OnKeyDown = LocationsUnitWindowGridKeyDown
    RowHeights = (
      24
      24
      25
