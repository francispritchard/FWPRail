...
VAR
  ...
  BEGIN
    TRY
      WITH StationMonitorsWindow.Canvas DO BEGIN
        Font.Style := [fsBold];
        Font.Height := -MulDiv(MainWindow.ClientHeight, StationMonitorsSmallFontHeight, 1000);
        ...
        Font.Height := -MulDiv(MainWindow.ClientHeight, StationMonitorsLargeFontHeight, 1000);
        Font.Style := [];
